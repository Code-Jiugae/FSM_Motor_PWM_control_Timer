...
set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { i_timer_mode  }]; #IO_L19P_T3_A10_D26_14      ,Sch=SW1
...
set_property -dict { PACKAGE_PIN W19  IOSTANDARD LVCMOS33 } [get_ports { i_button_time[1] }]; #IO_L16N_T2_A15_D31_14 ,Sch=BTNL
set_property -dict { PACKAGE_PIN T17  IOSTANDARD LVCMOS33 } [get_ports { i_button_time[0] }]; #IO_L17P_T2_A14_D30_14 ,Sch=BTNR
